...
class KnowablesStories extends StatefulWidget {
  final bool? showAppBar;
  const KnowablesStories({Key? key, this.showAppBar = true}) : super(key: key);

  @override
  State<KnowablesStories> createState() => _KnowablesStoriesState();
}

class _KnowablesStoriesState extends State<KnowablesStories> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showAppBar!
          ? AppBar(
              centerTitle: true,
              title: Text('Knowables', style: themeTextStyle(context: context)),
            )
          : null,
      body: isLoading
