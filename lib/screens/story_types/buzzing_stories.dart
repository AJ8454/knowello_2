...
class BuzzingStories extends StatefulWidget {
  final bool? showAppBar;
  const BuzzingStories({Key? key, this.showAppBar = true}) : super(key: key);

  @override
  State<BuzzingStories> createState() => _BuzzingStoriesState();
}

class _BuzzingStoriesState extends State<BuzzingStories> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showAppBar!
          ? AppBar(
              centerTitle: true,
              title: Text('Buzzing', style: themeTextStyle(context: context)),
            )
          : null,
      body: isLoading
